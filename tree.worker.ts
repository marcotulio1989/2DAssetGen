...
const treeStyles = {
  ...
  Oak: {
    ...
    leafSizeFactor: () => 0.2 + 0.1 * random(), // Smaller leaves
    midBranchChance: 0.9, // More mid-branches
    leafClusterBase: 2.5, // More leaves
    leafClusterAdd: 30, // More leaves
